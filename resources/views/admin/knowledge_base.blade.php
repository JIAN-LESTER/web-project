            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="action-buttons">
                        <button type="button" class="btn upload-document-btn" id="openUploadModalBtn">
                            ...
                            @forelse($documents as $index => $doc)
                                <tr class="document-row" data-doc-id="{{ $doc->kbID }}" style="--i: {{ $index }}">
                                    ...
                                    <td class="doc-category-cell">
                                        ...
                                        @endphp
                                        <span class="category-badge" data-category-id="{{ $doc->categoryID }}">
                ...
                <form action="{{ route('kb.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="kb_title" name="kb_title" class="minimalist-input" required
                        ...
                        <div class="form-group file-upload-group">
                            ...
                            <div class="file-upload-area">
                                <input type="file" id="document" name="document" class="file-input"
                                    accept=".pdf,.docx,.txt,.doc,.xlsx,.pptx" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function filterTable() {
                ...
                const existingNoResultsRow = document.getElementById('noSearchResults');
                if (existingNoResultsRow) {
                    existingNoResultsRow.remove();
                }

                // Show "no results" row if nothing matched
                if (matches === 0 && (searchTerm !== '' || selectedCategory !== '')) {
            ...
            if (liveSearch) {
                liveSearch.addEventListener('input', filterTable);
            }
